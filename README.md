...
Run the installer. The installer will create a "Machine Party Modded" shortcut in the start menu (press the windows key to access). This shortcut is the only way to launch modded, unless you want to set up parameters.
